...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    setcookie("varrr", $table_name, time() + 3600); // Set expiration time to 1 hour

    // Use the global connection object
    global $con;

    // Prepare the SQL query
    // $query = "CREATE TABLE IF NOT EXISTS `$table_name` (attendance VARCHAR(1) DEFAULT 'P') AS SELECT prn, roll_no, name FROM studentinfo";
    ...
    header("Location: fetchattendancepageforteacher.php");
