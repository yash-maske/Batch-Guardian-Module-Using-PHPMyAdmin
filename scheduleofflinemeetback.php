...
if (isset($_POST['SubmitContact'])) {
    ...
    ob_start();
    include 'invitionmailofflinepromt.php'; // Ensure this file contains valid HTML and PHP to render the message
    ...
    try {
        ...
        $message = str_replace(['{{date}}', '{{time}}'], [ htmlspecialchars($date), htmlspecialchars($time)], $message);
