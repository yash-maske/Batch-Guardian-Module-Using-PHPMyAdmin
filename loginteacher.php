...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $password = $_POST['pass__word'];
    

    setcookie("usert", $username, time() + 3600);

    $sql = "select * from registrationt where user__name = '$username' and pass__word = '$password'";
